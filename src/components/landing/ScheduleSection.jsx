...
// יום 1 - יום ראשון, יום 2 - יום שני, יום 3 - יום שלישי (+ מפגש שחקן), יום 4 - יום רביעי, יום 5 - יום חמישי
const groupAActivities = [
  ["התכנסות והיכרות", "התכנסות וחימום", "התכנסות וחימום", "התכנסות וחימום", "התכנסות וחימום"],
  ["פעילות פתיחה - שיתוף פעולה", "אימון בוקר", "מפגש עם שחקן מליגת העל ⚽", "אימון בוקר - מאמן נוער", "פילאטיס"],
